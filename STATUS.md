...
현재 버전: `v0.3.2` / GitHub: `tiamatiramisu/mullive-plusplus` / Greasy Fork: [593484](https://greasyfork.org/ko/scripts/593484)
...
- [ ] Stage 4 — 수동 m×n 격자 `v0.4.0`
- [ ] Stage 5 — 드래그 위치 교환 `v0.5.0`
...
1. 포그라운드에서 열 모드 채팅 3개에 실제로 메시지가 흐르는지 사용자 확인
   (자동 검증은 배경 탭이라 렌더가 throttle된다)
2. Stage 5 (드래그 위치 교환) — 절대 위치라 좌표 교환만 하면 된다
3. Stage 4 (수동 m×n 격자)
